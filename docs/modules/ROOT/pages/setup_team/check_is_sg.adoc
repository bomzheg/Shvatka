...
image::{attachmentsdir}/team/tg-check_is_sg-bot_show.png[]

.Бот не даст создать команду, даже если проигнорировать его предупреждения
image::{attachmentsdir}/team/tg-check_is_sg-error.png[]

.Кроме того, можно явно спросить тип чата командой `/chat_type`
image::{attachmentsdir}/team/tg-check_is_sg-chat_type.png[]

.После успешного преобразования группы — бот сразу сообщит
image::{attachmentsdir}/team/tg-check_is_sg-after_sg.png[]
