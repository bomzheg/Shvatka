...
image::{attachmentsdir}/team/tg-create_group-sidebar.jpg[]
...
image::{attachmentsdir}/team/tg-create_group-people.jpg[]

.С помощью поиска (или прокрутки списка контактов) находим кого-нибудь и добавляем в чат
image::{attachmentsdir}/team/tg-create_group-members.jpg[]

.После этого возможно создать группу
image::{attachmentsdir}/team/tg-create_group-submit.jpg[]

.На этом этапе можно ввести имя чата. Рекомендуется название команды, но в дальнейшем можно изменить
image::{attachmentsdir}/team/tg-create_group-name.jpg[]

.Группа создана
image::{attachmentsdir}/team/tg-create_group-finish.png[]
