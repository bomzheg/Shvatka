...
def upgrade():
    ...
    op.execute(
        ...
        set scenario['time_hints'][2]['hint'] =
         '[{"type": "text", "text": "Google 55.5923249, 37.9014795 Яндекс 55.592315, 37.901592"}]'::jsonb 
    ...
    op.execute(
        sa.text("""
        update levels 
        set scenario['time_hints'][4]['hint'] = '[{"type": "text", "text": "SHНЕВКУСНОИГРУСТНО"}]'::jsonb 
    ...
    op.execute(
        sa.text("""
        update levels 
        set scenario['time_hints'][4]['hint'] = '[{"type": "text", "text": "SHБУДЬКАКЧИСТОМЭН"}]'::jsonb 
    ...
    op.execute(
        sa.text("""
        update levels 
        set scenario['time_hints'][4]['hint'] = '[{"type": "text", "text": "SHБИОХАКИНГ"}]'::jsonb 
    ...
    op.execute(
        sa.text("""
        update levels 
        set scenario['time_hints'][4]['hint'] = '[{"type": "text", "text": "SHPRESSF"}]'::jsonb 
    ...
    op.execute(
        sa.text("""
        update levels 
        set scenario['time_hints'][4]['hint'] = '[{"type": "text", "text": "SHЛОЛКЕК"}]'::jsonb 
    ...
    op.execute(
        sa.text("""
        update levels 
        set scenario['time_hints'][4]['hint'] = '[{"type": "text", "text": "SHЗОЖНИКУЕЖНИК"}]'::jsonb 
    ...
    op.execute(
        sa.text("""
        update levels 
        set scenario['time_hints'][3]['hint'] = '[{"type": "text", "text": "SHБУДЬЗДОРОВ"}]'::jsonb 
    ...
    op.execute(
        sa.text("""
        update levels 
        set scenario['time_hints'][3]['hint'] = '[{"type": "text", "text": "SH1SQSH2DTSH3LMSH4EKSH5OVSH6CD"}]'::jsonb 
    ...
    op.execute(
        sa.text("""
        update levels 
        set scenario['time_hints'][4]['hint'] = '[{"type": "text", "text": "SHЗОЖНЫЕНЯШЕЧКИ"}]'::jsonb 
    ...
    op.execute(
        sa.text("""
        update levels 
        set scenario['time_hints'][0]['hint'] = '[{"type": "text", "text": "http://cxbatka.ru/images/games/ram/video/rickdance.mp4"}]'::jsonb 
    ...
    op.execute(
        ...
        update levels
        set
            scenario['time_hints'][1]['hint'] = '[{"type": "text", "text": "http://cxbatka.ru/images/games/apofimg/5ide02.mp4"}]'::jsonb,
            scenario['time_hints'][2]['hint'] = '[{"type": "text", "text": "http://cxbatka.ru/images/games/apofimg/v1de01.mp4"}]'::jsonb
    ...
    op.execute(
        sa.text("""
        update levels
        set scenario['time_hints'][2]['hint'] = '[{"type": "text", "text": "https://savepic.net/10028847.jpg"}]'::jsonb
    ...
    op.execute(
        sa.text("""
        update levels
        set scenario['time_hints'][3]['hint'] = '[{"type": "text", "text": "<a href=\\"https://maps.app.goo.gl/p1JL9jeZTCyus4fT7\\">Координаты</a>"}]'::jsonb
    ...
    op.execute(
        sa.text("""
        update levels
        set scenario['time_hints'][3]['hint'] = '[{"type": "text", "text": "<a href=\\"https://maps.app.goo.gl/4D4egcbChPboqbmX6\\">Тутки</a>"}]'::jsonb
    ...
    op.execute(
        sa.text("""
        update levels
        set scenario['time_hints'][0]['hint'] = '[{"type": "text", "text": "&nbsp;"}]'::jsonb
    ...
    op.execute(
        sa.text("""
        update levels
        set scenario['time_hints'][0]['hint'] = '[{"type": "text", "text": "Задание 3 \\n<b>Средний</b> \\nФормат ключа: SH(слово на русском)"}]'::jsonb
    ...
    op.execute(
        sa.text("""
        update levels
        set scenario['time_hints'][0]['hint'] = '[{"type": "text", "text": "http://www.youtube.com/v/qyss5RvaAso?fs=1&hl=ru_RU&rel=0"}]'::jsonb
    ...
    op.execute(
        sa.text("""
        update levels
        set scenario['time_hints'][0]['hint'] = '[{"type": "text", "text": "<a href=\\"http://www.nik0las.ru/cgi-bin/timer.py\\">Музыкальная пауза</a>"}]'::jsonb
    ...
    op.execute(
        sa.text("""
        update levels 
        set scenario['conditions'] = '[{"keys": ["SHКАЖДЫЙМОЖЕТСТАТЬПИЛОТОМ"], "type": "WIN_KEY"}]'::jsonb 
