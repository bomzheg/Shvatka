...
from src.infrastructure.crawler.constants import TEAMS_URL
from src.infrastructure.crawler.factory import get_paths
from src.infrastructure.crawler.models.team import ParsedPlayer, ParsedTeam
