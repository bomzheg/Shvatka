...
from src.shvatka.interfaces.dal.waiver import (
    WaiverVoteAdder,
    WaiverVoteGetter,
    WaiverApprover,
    GameWaiversGetter,
...
from src.shvatka.services.player import get_checked_player_on_team, get_full_team_player
from src.shvatka.utils.exceptions import WaiverForbidden, PermissionsError
