...
from src.common.factory import create_telegraph, create_dataclass_factory
from src.infrastructure.clients.factory import create_file_storage
from src.infrastructure.db.faсtory import create_pool, create_lock_factory, create_level_test_dao
from src.infrastructure.scheduler.factory import create_scheduler
...
from src.tgbot.views.jinja_filters import setup_jinja
